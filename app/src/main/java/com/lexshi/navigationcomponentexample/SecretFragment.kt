package com.lexshi.navigationcomponentexample

import android.os.Bundle
import android.view.View
import androidx.fragment.app.Fragment
import androidx.navigation.fragment.findNavController
import com.lexshi.navigationcomponentexample.databinding.FragmentSecretBinding
...
class SecretFragment : Fragment(R.layout.fragment_secret)  {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.goBackButton.setOnClickListener{
            ...
            //или findNavController().navigateUp()
